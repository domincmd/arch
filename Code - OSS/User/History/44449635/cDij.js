...
async function verifyUser(username, email, password) {
    ...
    try {
        const result = await collection.findOne({ username: username, email: email, password: password }); //this works 
        console.log("Found user: " + result);  // THIS OUTPUTS [object Object]
